...
(function() {
    ...
    AbstractChosen = (function() {
        ...
        AbstractChosen.prototype.set_default_values = function() {
            ...
            this.ajaxURL = this.options.ajaxURL || false;
            ...
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
                ...
                if (options != null ? options.first : void 0) {
                    if (data.selected && this.is_multiple) {
                        ...
                        this.single_set_selected_text(data.text, data.small);
                    }
                }
            }
            return content;
        ...
        AbstractChosen.prototype.keyup_checker = function(evt) {
            ...
            switch (stroke) {
                ...
                case 13:
                    evt.preventDefault();
                    if (this.enableAddOnEnter && !this.result_highlight) {
    ...
    Chosen = (function(_super) {
        ...
        Chosen.prototype.activate_field = function() {
            ...
            return (this.search_field.get(0) || {focus:function(){return true;}}).focus();
        };
        ...
        Chosen.prototype.results_show = function() {
            ...
            (this.search_field.get(0) || {focus:function(){return true;}}).focus();
            this.search_field.val(this.search_field.val());
            this.winnow_results();
