        ...
        "32da": function(e, t, r) {
            ...
            r.r(t), t['default'] = {
                ...
                render: function(e, t) {
                    var r = t._c;
                    return r("i", {
                        class: ["fa fa-trash-o",t.data.class, t.data.staticClass],
                        style: [t.data.style, t.data.staticStyle],
                        attrs: {
                            xmlns: "",
                            viewBox: ""
        ...
        fb15: function(e, t, r) {
                    ...
                    return _(t, e), w(t, [{
                        ...
                        value: function() {
                            ...
                            return e("div", {
                                ...
                                on: {
                                    click: this.handleClearPlaylist
                                }
                            }), 0 !== i ? e(Se, {
                                attrs: {
                                    type: "lrc",
                        ...
                        value: function() {
                            ...
                            return e("div", {
                                ...
                                on: {
                                    ...
                                    clearPlaylist: this.handleClearPlaylist,
                        ...
                        value: function() {
                            ...
                            return t("ol", {
                                ...
                                return t("li", {
                                  ...
                                  class: 'aplayer-remove fa fa-times',
                                  on: {
                                    click: function(ev) {
                                      return e.$emit("remove", r, n, ev);
                                    }
                                  }
                                }, [''])])
                            })])
            ...
            var et = function(e) {
                ...
                return _(t, e), w(t, [{
                    ...
                    value: function() {
                        var e = v(regeneratorRuntime.mark(function e(t, r) {
                            ...
                            return regeneratorRuntime.wrap(function(e) {
                                while (1) switch (e.prev = e.next) {
                                    case 0:
                                        if (t.theme ? this.currentTheme = t.theme : (n = t.cover || this.options && this.options.defaultCover, n && setTimeout(v(regeneratorRuntime.mark(function e() {
                                                return regeneratorRuntime.wrap(function(e) {
                                                    while (1) switch (e.prev = e.next) {
                                                        case 0:
                    ...
                    value: function() {
                        if (this.media.ended) switch (this.currentPlayed = 0, this.currentLoop) {
                            ...
                            case "none":
                                ...
                                } else this.handleSkipForward();break
                        }
                    }
                }, {
                    ...
                    key: "handleRemovePlaylist",
                    value: function(e, t, ev) {
                    ...
                    value: function() {
                        ...
                        Ze && this.mutex && Ze.addEventListener("message", function(t) {
                            ...
                            e.player.addEventListener(t, function(r) {
                                return e.$emit(t, r, e.currentMusic)
                            })
                        })
                    }
                }, {
                    ...
                    value: function() {
                        ...
                        return e("div", {
                            ...
                            on: {
                                ...
                                remove: this.handleRemovePlaylist
                            }
                        }), r && 0 !== n ? e(fe, {
                            attrs: {
                                visible: f
...
//# sourceMappingURL=VueAPlayer.umd.min.js.map