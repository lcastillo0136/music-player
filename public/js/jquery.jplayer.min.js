    ...
    b.jPlayer.prototype = {
        ...
        _getHtmlStatus: function(a, c) {
            var b = 0,
                ...
                g = 0,
                f = 0;
            (isFinite(a.duration) && (this.status.duration = a.duration)) || (this.status.duration = a.song.duration);
            b = a.currentTime;
            ...
            c && (e = f = b = 0);
            this.status.seekPercent = g==0? 100 : g;
            this.status.currentPercentRelative = f==0?e:f;
        ...
        _html_initMedia: function(a) {
            ...
            this.htmlElement.media.song = a.song;
        ...
        _html_playHead: function(a) {
            ...
            this._html_load();
            try {
                if ("object" === typeof d.seekable && 0 < d.seekable.length) d.currentTime = a * (isFinite(d.seekable.end(d.seekable.length - 1)) ? d.seekable.end(d.seekable.length - 1) : d.song.duration ) / 100;
